  ...
  const balanceSheetData = [
    {
      ...
      totalAssets: 123123,
      totalEquity: 123123,
      totalLiabilitiesAndEquity: 123123,
    },
  ];
      ...
      <div className="bg-white rounded-lg p-4 md:p-10">
        ...
        >
          <header className="text-center mb-8">
            ...
            <h2 className="text-xl md:text-2xl">Financial Report</h2>
              ...
              <table className="min-w-full border mt-4">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2 font-bold" colSpan="2">Total Liabilities and Equity – {formatCurrency(balanceSheetData[0].totalLiabilitiesAndEquity)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="min-w-full border mt-4">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2 font-bold">Net Income – {formatCurrency(incomeStatementData[0].netIncome)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="min-w-full border mt-4">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2 font-bold">Ending Balance – {formatCurrency(cashFlowData[0].endingBalance)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
